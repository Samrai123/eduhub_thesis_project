...
class PythonDetailsScreen extends StatefulWidget {
  final String? title;
  ...
  @override
  _PythonDetailsScreenState createState() => _PythonDetailsScreenState();
}

class _PythonDetailsScreenState extends State<PythonDetailsScreen> {
  int _selectedTag = 0;
    ...
    return Expanded(
      child: AnimationLimiter(
        child: ListView.separated(
          ...
          shrinkWrap: true,
          itemCount: pythonLessonList.length,
          itemBuilder: (_, index) {
            return AnimationConfiguration.staggeredList(
              ...
              child: SlideAnimation(
                ...
                child: FadeInAnimation(
                  child: _PythonLessonCard(lesson: pythonLessonList[index]),
                ),
              ),
            );
          },
...
class _PythonLessonCard extends StatelessWidget {
  final PythonLesson lesson;
  const _PythonLessonCard({Key? key, required this.lesson}) : super(key: key);
