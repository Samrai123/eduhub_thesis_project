...
class DartDetailsScreen extends StatefulWidget {
  final String? title;
  const DartDetailsScreen({
    Key? key,
    this.title,
  }) : super(key: key);

  @override
  _DartDetailsScreenState createState() => _DartDetailsScreenState();
}

class _DartDetailsScreenState extends State<DartDetailsScreen> {
  int _selectedTag = 0;
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //   endAt: Duration(minutes: 1, seconds: 00),
                // ),
                const SizedBox(
                  height: 15,
                ),
                Text(
                  "Dart - Beginner guide to Flutter",
                  style: TextStyle(
    ...
    return Expanded(
      child: AnimationLimiter(
        child: ListView.separated(
          ...
          shrinkWrap: true,
          itemCount: dartLessonList.length,
          itemBuilder: (_, index) {
            return AnimationConfiguration.staggeredList(
              ...
              child: SlideAnimation(
                ...
                child: FadeInAnimation(
                    child: _DartLessonCard(lesson: dartLessonList[index])),
              ),
            );
          },
        ),
...
class _DartLessonCard extends StatelessWidget {
  final DartLesson lesson;
  const _DartLessonCard({Key? key, required this.lesson}) : super(key: key);
